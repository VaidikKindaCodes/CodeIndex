...
`;
  ...
  return (
    ...
    // </div>
    <div className="min-h-screen w-full backdrop-blur-md flex flex-col items-center p-8">
  <div className="bg-white/90 dark:bg-zinc-900/80 shadow-2xl rounded-2xl p-8 max-w-3xl w-full border border-zinc-200 dark:border-zinc-800">
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <h2 className="font-extrabold text-transparent text-4xl md:text-5xl text-center bg-clip-text bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 drop-shadow">
        CodeChef API Documentation
      </h2>
    </div>

    {/* Intro Paragraph */}
    <p className="mt-3 max-w-2xl text-center text-lg text-zinc-700 dark:text-zinc-200 leading-relaxed">
      Effortlessly fetch and display your{" "}
      <span className="font-semibold text-green-600 dark:text-green-400">
        CodeChef
      </span>{" "}
    ...
    <div className="mt-8 w-full max-w-xl mx-auto flex flex-col items-center">
      ...
      <div className="flex w-full">
        <input
          id="leetcode-link"
          type="text"
          className="flex-1 px-4 py-2 rounded-l-md border border-gray-300 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-green-400 dark:bg-zinc-800 dark:text-white"
          placeholder={finalUrl}
          disabled
        />
        <button
    ...
    {/* Usage Section */}
    <div className="mt-10 max-w-2xl mx-auto text-left text-base">
      <h3 className="font-semibold mb-2 flex items-center gap-2 text-green-600 dark:text-green-400 text-lg">
        📌 Usage:
      </h3>
      ...
      {/* JSON Response */}
      <h3 className="font-semibold mt-6 mb-2 flex items-center gap-2 text-green-600 dark:text-green-400 text-lg">
        📦 The JSON Response will look as follows:
      </h3>
      <div className="rounded-lg overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-700 my-4">
        <div
      ...
      {/* Closing Paragraph */}
      <p className="mt-8 max-w-2xl text-center text-lg text-zinc-700 dark:text-zinc-200 leading-relaxed">
