...
`;
    ...
    return (
        ...
        // </div>
        <div className="min-h-screen w-full backdrop-blur-md flex flex-col items-center p-8">
  <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl rounded-2xl p-8 max-w-3xl w-full">
    ...
    {/* Title */}
    <h2 className="text-4xl text-center font-extrabold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent mb-4 tracking-tight drop-shadow">
      <span className="inline-block align-middle mr-2">👨🏻‍💻</span>
      Codeforces API Documentation
    </h2>

    {/* Description */}
    <p className="mt-3 max-w-2xl text-center text-lg text-neutral-700 dark:text-neutral-300">
      Effortlessly fetch and display your{" "}
      <span className="font-semibold text-blue-500 dark:text-blue-400">
        Codeforces
      </span>{" "}
      profile stats with our API. Retrieve your rating, rank, problems solved, and
      more. Enter your Codeforces username below and copy the generated API link.
    </p>
    ...
    <div className="mt-8 w-full max-w-xl mx-auto flex flex-col items-center">
      <label
        htmlFor="codeforces-link"
        className="mb-2 font-medium text-lg text-neutral-800 dark:text-neutral-100"
      >
        Codeforces Profile API Link
      </label>
      <div className="flex w-full">
        <input
          id="codeforces-link"
          type="text"
          className="flex-1 px-4 py-2 rounded-l-lg border border-neutral-300 dark:border-neutral-700 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-neutral-800 dark:text-white"
          placeholder={finalUrl}
          disabled
        />
        <button
          type="button"
          className="px-4 py-2 bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-r-lg hover:from-blue-500 hover:to-blue-700 transition font-semibold shadow"
          onClick={copyToClipBoard}
        >
          Copy
        </button>
    ...
    <div className="mt-10 max-w-2xl mx-auto text-left text-base">
      ...
      <div className="rounded-xl overflow-hidden shadow-lg border border-neutral-200 dark:border-neutral-800 my-4">
        <div
          className="shiki overflow-x-auto text-base leading-relaxed rounded-lg p-4 bg-gray-900 border border-gray-800"
          style={{
            fontFamily:
      ...
      {/* Footer note */}
      <p className="mt-8 max-w-2xl text-center text-lg text-neutral-700 dark:text-neutral-300">
        Use this data to beautifully showcase your Codeforces coding stats on
        your website!
      </p>
    </div>
