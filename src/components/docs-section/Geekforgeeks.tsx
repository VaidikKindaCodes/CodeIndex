  ...
  return (
    <div className="min-h-screen w-full  backdrop-blur-md flex flex-col items-center p-8">
      <div className="bg-white/90 dark:bg-zinc-900/80 shadow-xl rounded-2xl p-8 max-w-3xl w-full">
        <h2 className="text-4xl text-center font-extrabold text-cyan-500 dark:text-cyan-300 mb-4 tracking-tight drop-shadow">
        ...
        <div className="mt-8 w-full max-w-xl mx-auto flex flex-col items-center">
          ...
          <div className="flex w-full">
            <input
              id="leetcode-link"
              type="text"
              className="flex-1 px-4 py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 dark:bg-zinc-800 dark:text-white"
              placeholder={finalUrl}
              disabled
            />
            <button
              type="button"
              className="px-4 py-2 bg-gradient-to-r from-cyan-400 to-blue-300 text-white rounded-r-md hover:from-cyan-500 hover:to-blue-200 transition font-semibold shadow"
        ...
        <div className="mt-10 max-w-2xl mx-auto text-left text-base">
          <h3 className="font-semibold mb-2 text-blue-600 dark:text-cyan-400 text-lg">
            Usage:
          </h3>
