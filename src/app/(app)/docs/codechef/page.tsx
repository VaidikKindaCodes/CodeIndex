...
import CodeChef from '@/components/docs-section/Codechef';

export const metadata = {
    title: 'CodeChef API Documentation',
    description: 'Retrieve your CodeChef profile stats including rating, stars, and problems solved.',
};
